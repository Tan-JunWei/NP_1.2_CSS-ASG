...
// It defaults to /home/singapore.jpg (hero) but can accept different imageSrc, orientation and scale.
const ParallaxHeroSection = ({ imageSrc = "/home/singapore.jpg", orientation = "up", scale = 1.4 }) => (
  <SimpleParallax orientation={orientation} scale={scale}>
    ...
    <div className={styles.container}>
      ...
      <div className={styles.hero}>
        ...
        <p className={styles.subheader}>
          Discover the rich flavors and diverse culinary heritage of Singapore
        </p>
        <div className={styles.buttonWrapper}>
          ...
          >
            Explore <FaChevronDown className={styles.bounceIcon} />
          </button>
        </div>
      </div>
      ...
      <div id="contentSection" className={styles.contentSection}>
        <section className={styles.foodSection}>
          <h2>
            The Heart of Singapore: A Melting Pot of Culinary Cultures
          </h2>
          <div className={`${styles.foodItem} ${styles.left}`}>
            <img
              src="/home/cultures.png"
      ...
      {/* Taste Explorer / Discover Section */}
      <div className={styles.tasteExplorer}>
        <ParallaxHeroSection
          imageSrc="/home/discover.jpeg"
          orientation="up"
          scale={1.4}
        />
        <div className={styles.tasteExplorerContent}>
          <h2 className={styles.tasteExplorerTitle}>
